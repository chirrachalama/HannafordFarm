...
import com.nurture.Util.TestUtility;
...
public class TestBase extends TestUtility{
	...
	public TestBase(){
		...
		try {
			prop = new Properties();
			FileInputStream ip=new FileInputStream("C:\\Users\\CHALAMA\\eclipse-workspace\\HannafordFarmExchange\\src\\main\\java\\com\\nurture\\Config\\config.properties");
			prop.load(ip);
	...
	@DataProvider
	public Iterator<Object[]> BuyerAccount()
	{
			ArrayList<Object[]> testdata=BuyerAccountExcelUtil.getDataFromExcel();
			return testdata.iterator();
	}
	
	@DataProvider
	public Iterator<Object[]> SellerAccount()
	{
			ArrayList<Object[]> testdata=SellerAccountExcelUtil.getDataFromExcel();
			return testdata.iterator();
	}
